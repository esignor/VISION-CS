...
\hline
\begin{tabular}[c]{cc}BlendMask R-CNN: \\ ResNet-101-FPN $+$ dcni \end{tabular} & \begin{tabular}[c]{ccc}box AP: 32.196\\ mask AP: 27.212\end{tabular} & \begin{tabular}[c]{ccc}box AP: 20.497\\ mask AP:  20.236\end{tabular} \\
\hline
\end{tabular}
\end{center}
