...
Architecture & \textit{Cityscapes} & \textit{WildDash}\\
\hline\hline
\begin{tabular}[c]{ccc}\textbf{Mask R-CNN:} \\ \textbf{ResNet-101-FPN $+$} \\ \textbf{freeze at 2nd} \end{tabular} & \begin{tabular}[c]{ccc}\textbf{box AP: 28.563}\\ \textbf{mask AP: 24.676}\end{tabular} & \begin{tabular}[c]{ccc}\textbf{box AP: 19.024} \\ \textbf{mask AP: 17.994}\\\end{tabular} \\
\hline
...
Architecture & \textit{Cityscapes} & \textit{WildDash}\\
\hline\hline
\begin{tabular}[c]{ccc}\textbf{BlendMask:} \\ \textbf{ResNet-101-FPN $+$} \\ \textbf{freeze at 2nd} \end{tabular} & \begin{tabular}[c]{ccc}\textbf{box AP: 31.017}\\ \textbf{mask AP: 26.411}\end{tabular} & \begin{tabular}[c]{ccc}\textbf{box AP: 20.347} \\ \textbf{mask AP: 20.162}\end{tabular} \\
\hline
