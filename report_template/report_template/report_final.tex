...
\hline\hline
\begin{tabular}[c]{cc}Mask R-CNN: \\ ResNet-50-C4 \end{tabular} & \begin{tabular}[c]{ccc}box AP: 25.935\\ mask AP: 20.005 \end{tabular} & \begin{tabular}[c]{ccc}box AP: 18.730\\ mask AP: 17.589\end{tabular} \\
\hline
...
\hline
\begin{tabular}[c]{cc}Mask R-CNN: \\ ResNet-101-C4 \end{tabular} & \begin{tabular}[c]{ccc}box AP:\\ mask AP:\end{tabular} & \begin{tabular}[c]{ccc}box AP: \\ mask AP:\end{tabular} \\
\hline
\begin{tabular}[c]{cc}Mask R-CNN: \\ ResNet-101-DC5\end{tabular}& \begin{tabular}[c]{ccc}box AP:\\ mask AP:\\ train time:\end{tabular} & \begin{tabular}[c]{ccc}box AP:\\ mask AP:\end{tabular} \\
\hline
\begin{tabular}[c]{cc}Mask R-CNN: \\ ResNet-101-FPN \end{tabular} & \begin{tabular}[c]{ccc}box AP: \\ mask AP: \\ train time:\end{tabular} & \begin{tabular}[c]{ccc}box AP: \\ mask AP:\end{tabular}  \\
\hline
\end{tabular}
\end{center}
\label{mytable_backbone_Mask-RCNN}
...
Method & \textit{Cityscapes} & \textit{WildDash}\\
\hline\hline
\begin{tabular}[c]{cc}BlendMask R-CNN: \\ ResNet-50-FPN \end{tabular} & \begin{tabular}[c]{ccc}box AP: \\ mask AP: \\ train time:\end{tabular} & \begin{tabular}[c]{ccc}box AP: \\ mask AP:\end{tabular}  \\
\hline
\begin{tabular}[c]{cc}BlendMask R-CNN: \\ ResNet-50-FPN \end{tabular} & \begin{tabular}[c]{ccc}box AP:\\ mask AP: \\ train time: \end{tabular} & \begin{tabular}[c]{ccc}box AP: \\ mask AP:\end{tabular} \\
\hline
\begin{tabular}[c]{cc}BlendMask R-CNN: \\ ResNet-50-FPN $+$ dcni \end{tabular} & \begin{tabular}[c]{ccc}box AP:\\ mask AP: \\ train time: \end{tabular} & \begin{tabular}[c]{ccc}box AP: \\ mask AP:\end{tabular} \\
\hline
\begin{tabular}[c]{cc}BlendMask R-CNN: \\ ResNet-101-FPN $+$ dcni \end{tabular} & \begin{tabular}[c]{ccc}box AP:\\ mask AP: \\ train time: \end{tabular} & \begin{tabular}[c]{ccc}box AP: \\ mask AP:\end{tabular} \\
\hline
\end{tabular}
\end{center}
...
\begin{tabular}{|c|c|c|}
\hline
Method & \textit{Cityscapes} AP & \textit{WildDash} AP\\
\hline\hline
\begin{tabular}[c]{ccc}Mask R-CNN: \\ ResNet-101-FPN $+$ \\ 1 freeze layer \end{tabular} & \begin{tabular}[c]{ccc}box AP:\\ mask AP: \end{tabular} & \begin{tabular}[c]{ccc}box AP: \\ mask AP: \\ train time:\end{tabular} \\
\hline
\begin{tabular}[c]{ccc}BlendMask: \\ ResNet-101-FPN $+$ \\ 1 freeze layer \end{tabular} & \begin{tabular}[c]{ccc}box AP:\\ mask AP: \end{tabular} & \begin{tabular}[c]{ccc}box AP: \\ mask AP:\end{tabular} \\
\hline
\begin{tabular}[c]{ccc}Mask R-CNN: \\ ResNet-101-FPN $+$ \\ 4 freeze layer \end{tabular} & \begin{tabular}[c]{ccc}box AP:\\ mask AP:\end{tabular} & \begin{tabular}[c]{ccc}box AP: \\ mask AP: \end{tabular} \\
\hline
\begin{tabular}[c]{ccc}BlendMask: \\ ResNet-101-FPN $+$ \\ 4 freeze layer \end{tabular} & \begin{tabular}[c]{ccc}box AP:\\ mask AP: \end{tabular} & \begin{tabular}[c]{ccc}box AP: \\ mask AP:\end{tabular} \\
\hline
\end{tabular}
\end{center}
\caption{Experiments on \textit{freeze layers}.}
\label{mytable_freeze_BlendMask}
\end{table}
...
Method & \textit{Cityscapes} & \textit{WildDash}\\
\hline\hline
\begin{tabular}[c]{cc}BlendMask R-CNN: \\ ResNet-101-FPN $+$ \\ ProtoNet  \end{tabular} & \begin{tabular}[c]{ccc}box AP: \\ mask AP: \\ train time:\end{tabular} & \begin{tabular}[c]{ccc}box AP: \\ mask AP:\end{tabular}  \\
\hline
\begin{tabular}[c]{cc}BlendMask R-CNN: \\ ResNet-101-FPN $+$ \\ DeepLabv3  \end{tabular} & \begin{tabular}[c]{ccc}box AP: \\ mask AP: \\ train time:\end{tabular} & \begin{tabular}[c]{ccc}box AP: \\ mask AP:\end{tabular}  \\
\hline
\end{tabular}
\end{center}
\label{mytable_backbone_Blendmask}
...
In conclusione ai nostri esperimenti abbiamo selezionato i seguenti \textit{ideal models} di Mask R-CNN e BlendMask per il task di \textit{Urban Street View} oggetto del nostro lavoro:
