...
\hline
\begin{tabular}[c]{cc}Mask R-CNN: \\ ResNet-101-C4 \end{tabular} & \begin{tabular}[c]{ccc}box AP: 30.888\\ mask AP: 24.562 \end{tabular} & \begin{tabular}[c]{ccc}box AP: 20.004 \\ mask AP: 18.155\end{tabular} \\
\hline
\begin{tabular}[c]{cc}Mask R-CNN: \\ ResNet-101-DC5\end{tabular}& \begin{tabular}[c]{ccc}box AP:\\ mask AP: \\ \end{tabular} & \begin{tabular}[c]{ccc}box AP:\\ mask AP:\end{tabular} \\
\hline
\begin{tabular}[c]{cc}Mask R-CNN: \\ ResNet-101-FPN \end{tabular} & \begin{tabular}[c]{ccc}box AP: \\ mask AP:\end{tabular} & \begin{tabular}[c]{ccc}box AP: \\ mask AP:\end{tabular}  \\
\hline
\end{tabular}
\end{center}
...
Method & \textit{Cityscapes} & \textit{WildDash}\\
\hline\hline
\begin{tabular}[c]{cc}BlendMask R-CNN: \\ ResNet-50-FPN \end{tabular} & \begin{tabular}[c]{ccc}box AP: \\ mask AP:\end{tabular} & \begin{tabular}[c]{ccc}box AP: \\ mask AP:\end{tabular}  \\
\hline
\begin{tabular}[c]{cc}BlendMask R-CNN: \\ ResNet-101-FPN \end{tabular} & \begin{tabular}[c]{ccc}box AP:\\ mask AP: \end{tabular} & \begin{tabular}[c]{ccc}box AP: \\ mask AP:\end{tabular} \\
\hline
\begin{tabular}[c]{cc}BlendMask R-CNN: \\ ResNet-50-FPN $+$ dcni \end{tabular} & \begin{tabular}[c]{ccc}box AP:\\ mask AP: \end{tabular} & \begin{tabular}[c]{ccc}box AP: \\ mask AP:\end{tabular} \\
\hline
\begin{tabular}[c]{cc}BlendMask R-CNN: \\ ResNet-101-FPN $+$ dcni \end{tabular} & \begin{tabular}[c]{ccc}box AP:\\ mask AP: \end{tabular} & \begin{tabular}[c]{ccc}box AP: \\ mask AP:\end{tabular} \\
\hline
\end{tabular}
\end{center}
...
\hline\hline
\begin{tabular}[c]{ccc}Mask R-CNN: \\ ResNet-101-FPN $+$ \\ 1 freeze layer \end{tabular} & \begin{tabular}[c]{ccc}box AP:\\ mask AP: \end{tabular} & \begin{tabular}[c]{ccc}box AP: \\ mask AP: \\\end{tabular} \\
\hline
