...
Architecture & \textit{Cityscapes} & \textit{WildDash}\\
\hline\hline
\begin{tabular}[c]{cc}BlendMask R-CNN: \\ ResNet-50-FPN \end{tabular} & \begin{tabular}[c]{ccc}box AP: 30.129 \\ mask AP: 25.325\end{tabular} & \begin{tabular}[c]{ccc}box AP: 20.225 \\ mask AP: 19.810\end{tabular}  \\
\hline
\begin{tabular}[c]{cc}BlendMask R-CNN: \\ ResNet-101-FPN \end{tabular} & \begin{tabular}[c]{ccc}box AP:30.922\\ mask AP: 25.922 \end{tabular} & \begin{tabular}[c]{ccc}box AP: 20.347 \\ mask AP: 20.162\end{tabular} \\
\hline
\begin{tabular}[c]{cc}BlendMask R-CNN: \\ ResNet-101-FPN $+$ dcni \end{tabular} & \begin{tabular}[c]{ccc}box AP: 32.196\\ mask AP: 27.212\end{tabular} & \begin{tabular}[c]{ccc}box AP: 21.047\\ mask AP:  21.222\end{tabular} \\
\hline
\end{tabular}
\end{center}
